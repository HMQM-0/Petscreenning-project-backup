...
import { WishlistErrorCode } from "deprecated/@nautical/gqlTypes/globalTypes";
...
export interface RemoveWishlistProductVariant_wishlistRemoveVariant {
   ...
   */
  wishlist:
    | (RemoveWishlistProductVariant_wishlistRemoveVariant_wishlist | null)[]
    | null;
  /**
  ...
  wishlistErrors:
    | RemoveWishlistProductVariant_wishlistRemoveVariant_wishlistErrors[]
    | null;
}
