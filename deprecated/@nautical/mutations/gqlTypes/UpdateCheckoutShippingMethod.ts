...
export interface UpdateCheckoutSellerShippingMethods_checkoutSellerShippingMethodsUpdate {
...
export interface UpdateCheckoutSellerShippingMethods {
  /**
   * Updates the seller shipping methods for the checkout.
   */
  checkoutSellerShippingMethodsUpdate: UpdateCheckoutSellerShippingMethods_checkoutSellerShippingMethodsUpdate | null;
}
...
export interface UpdateCheckoutSellerShippingMethodsVariables {
  checkoutId: string;
  seller: number;
