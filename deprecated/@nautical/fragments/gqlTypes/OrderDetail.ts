...
export interface OrderDetail_volumeDiscount {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
...
export interface OrderDetail_sellerFulfillments {
  id: string;
...
export interface OrderDetail {
   ...
   */
  discount: OrderDetail_subtotal_net | null;
  discountName: string | null;
  sellerFulfillments?: OrderDetail_sellerFulfillments[];
...
export interface NauticalOrderDetail {
   ...
   */
  subtotal: OrderDetail_subtotal | null;
  volumeDiscount: OrderDetail_volumeDiscount | null;
  discount: OrderDetail_subtotal_net | null;
  discountName: string | null;
  /**
   * Total amount of the order.
