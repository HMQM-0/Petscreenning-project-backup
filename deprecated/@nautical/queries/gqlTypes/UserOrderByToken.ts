...
export interface UserOrderByToken_nauticalOrderByToken_lines {
...
export interface UserOrderByToken_nauticalOrderByToken {
   ...
   * List of order lines.
   */
  lines: (UserOrderByToken_nauticalOrderByToken_lines | null)[];
  /**
   * The sum of line prices not including shipping.
   */
  subtotal: UserOrderByToken_orderByToken_subtotal | null;
...
export interface UserNauticalOrderByToken {
  /**
   * Look up an order by token.
   */
  nauticalOrderByToken: UserOrderByToken_nauticalOrderByToken | null;
}
