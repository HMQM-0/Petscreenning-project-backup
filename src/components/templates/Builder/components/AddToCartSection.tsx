...
import { useSelectedVariant } from "src/components/templates/ProductPage/View";
import { ProductDetailsFragment } from "src/components/templates/ProductPage/queries.graphql.generated";
