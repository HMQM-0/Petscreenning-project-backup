...
import {
  getNauticalClientSecret,
  getNauticalPaymentId,
  setNauticalClientSecret,
  setNauticalPaymentId,
} from "src/utils";
import { useCheckout, useAuth } from "nautical-api";
import { Loader } from "src/components/atoms/Loader";
import { useGetClientSecretQuery } from "src/queries/clientSecret.graphql.generated";
